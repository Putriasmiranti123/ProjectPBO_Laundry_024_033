...
public class PesananController {
    ...
    //Encapsulation: dibuat private agar koneksi database hanya dapat diakses dlm class ini
    ...
    //Polymorphism: Object layanan menggunakan parent class Layanan
    //tetapi dapat berisi object CuciSaja atau CuciSetrika.
    ...
    public boolean updatePesanan(int idPesanan, String namaPelanggan, int idLayanan, double beratKg, String status) {
        ...
        //PreparedStatement digunakan untuk keamanan query SQL
    ...
    private Layanan buatLayanan(int idLayanan) {
        switch (idLayanan) { //Polymorphism: krna mengambil object turunan dari class Layanan
