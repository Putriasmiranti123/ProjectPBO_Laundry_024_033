...
public class PesananView extends javax.swing.JFrame {
    ...
    private void applyStyles() {
        ...
        jLabelTotalBiaya.setFont(new java.awt.Font("Segoe UI", 0, 12));
        jLabelTotalBiaya.setForeground(new java.awt.Color(80, 80, 80));
        ...
        txtTotalBiaya.setBackground(new java.awt.Color(235, 245, 255));
        txtTotalBiaya.setBorder(javax.swing.BorderFactory.createEmptyBorder(2, 4, 2, 4));
        txtTotalBiaya.setFont(new java.awt.Font("Segoe UI", 1, 12));
        txtTotalBiaya.setForeground(new java.awt.Color(24, 95, 165));
        ...
        try {
            ...
            for (PesananDTO p : listPesanan) {
                model.addRow(new Object[]{
                    ...
                    p.getNamaLayanan(),
                    p.getBeratKg(),
                    p.getTotalBiayaFormatted(), // Masukkan Total Biaya terformat ke tabel
                    p.getStatus()
                });
            }
        } catch (Exception e) {
    ...
    private void initTabelListener() {
        jTable4.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                if (row != -1) {
                    idPesananDipilih = Integer.parseInt(jTable4.getValueAt(row, 0).toString());
                    ...
                    txtTotalBiaya.setText(jTable4.getValueAt(row, 4).toString()); // Tampilkan biaya saat baris diklik
                    jComboBox2.setSelectedItem(jTable4.getValueAt(row, 5).toString());
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        setTitle("Laundry In Ajah - Management System");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Proses", "Selesai" }));

        btnSimpan.setText("Simpan");
        btnEdit.setText("Edit");
        btnHapus.setText("Hapus");

        // Perubahan: Menambahkan kolom "Total Biaya" di dalam struktur tabel komponen
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            new Object[][] {},
            new String[] { "ID", "Nama Pelanggan", "Jenis Layanan", "Berat (Kg)", "Total Biaya", "Status" }
        ));
        ...
        // RE-DESIGN LAYOUT DENGAN TAMBAHAN FIELD TOTAL BIAYA
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtBerat, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
                                    .addComponent(jComboBox2, 0, 180, Short.MAX_VALUE)
                                    .addComponent(txtTotalBiaya, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)))
                            .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabelTotalBiaya)
                            .addComponent(txtTotalBiaya, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(25, 25, 25)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
