...
public class PesananDTO {
    // Encapsulation: privat biar data lebih aman
    //dan hanya bisa diakses melalui getter & setter.
    ...
    //Override method toString():  untuk menampilkan object dalam bentuk teks
    @Override
